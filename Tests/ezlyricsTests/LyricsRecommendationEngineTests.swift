...
@Suite struct LyricsRecommendationEngineTests {
    
    @Test func FiltersOutResultsWithoutLyrics() {
        let results = [
        ...
        #expect(recommended?.id == 2)
    }
    
    @Test func FiltersOutResultsWithLargeDurationMismatch() {
        let results = [
    ...
    @Test func PrioritizesSyncedLyrics() {
        let results = [
    ...
    @Test func PrioritizesExactStringMatches() {
        let results = [
